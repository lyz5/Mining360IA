...
BUSINESS_REVENUE_AUTO_SYNC = os.getenv('BUSINESS_REVENUE_AUTO_SYNC', 'true').lower() == 'true'
BUSINESS_REVENUE_AUTO_SYNC_RETRY_MINUTES = max(15, int(os.getenv('BUSINESS_REVENUE_AUTO_SYNC_RETRY_MINUTES', '60')))
