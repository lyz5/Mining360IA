...
class ReportingHubTests(TestCase):
    ...
    def test_premium_page_renders_catalog_and_business_status(self, list_reports):
        ...
        self.assertNotContains(response, 'class="report-health-summary"')
        self.assertNotContains(response, 'class="reporting-status-filters"')
        self.assertNotContains(response, "Total Reports")
