...
SAFE_INTENT_TYPES = {
    ...
    "equipment_detail",
    "fleet_inventory",
    "get_site_fleet", "get_site_fleet_by_model", "get_site_model_fleet",
    "get_fleet_count", "lookup_equipment_by_serial", "lookup_equipment_by_code",
    "export_current_fleet", "export_current_result", "fleet_follow_up", "fleet_clarification_required",
    "downtime_drivers",
    "trend_analysis",
    "entity_comparison",
    "period_comparison",
...
METRIC_OPTIONAL_INTENT_TYPES = {
    ...
    "performance_overview", "fleet_performance_overview", "reliability_overview",
    "multi_kpi_summary", "site_performance", "model_performance",
    "equipment_performance", "serial_performance", "planned_unplanned_analysis",
    "most_impacted_equipment", "down_hours_by_compartment", "down_hours_by_equipment",
    "component_analysis", "pm_analysis", "smu_tracking", "benchmark_analysis",
    "equipment_detail", "downtime_drivers",
    "fleet_inventory", "get_site_fleet", "get_site_fleet_by_model",
    "get_site_model_fleet", "get_fleet_count", "lookup_equipment_by_serial",
    "lookup_equipment_by_code", "export_current_fleet", "export_current_result", "fleet_follow_up",
