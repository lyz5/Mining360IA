(function () {
    ...
    const resourceConfig = {
        "capability-registry": {
            ...
            columns: ["capability_code", "domain_code", "display_name_en", "readiness_status", "readiness_score", "enabled"],
            fields: [
                ["agent_code", "Agent code", "text"], ["capability_code", "Capability code", "text"],
                ["domain_code", "Domain", "text"], ["category", "Category", "text"],
                ["display_name_en", "English name", "text"], ["display_name_fr", "French name", "text"],
                ["short_description_en", "English description", "textarea"], ["short_description_fr", "French description", "textarea"],
                ["supported_intents_json", "Supported intents", "json"], ["supported_metrics_json", "Supported metrics", "json"],
                ["supported_entities_json", "Supported entities", "json"], ["supported_operations_json", "Supported operations", "json"],
                ["required_data_sources_json", "Required data sources", "json"], ["required_permissions_json", "Required permissions", "json"],
                ["example_questions_en_json", "English examples", "json"], ["example_questions_fr_json", "French examples", "json"],
                ["readiness_score", "Readiness score", "number"],
                ["readiness_status", "Readiness", "select", ["Ready", "Limited", "Needs Configuration", "Disabled", "Invalid"]],
        ...
        "data-field-registry": {
            title: "Data Field Registry",
            columns: ["canonical_field_code", "entity_type", "display_name_en", "source_type", "configuration_status", "active"],
            fields: [
                ["canonical_field_code", "Canonical field code", "text"], ["entity_type", "Entity type", "text"],
                ["display_name_en", "English name", "text"], ["display_name_fr", "French name", "text"],
                ["description", "Description", "textarea"], ["synonyms_json", "Synonyms", "json"],
                ["data_type", "Data type", "select", ["Text", "Decimal", "Date", "DateTime", "Percentage"]],
                ["source_type", "Source type", "select", ["semantic_column", "semantic_measure", "knowledge", "business_rule", "none"]],
                ["semantic_model_id", "Semantic model ID", "text"], ["table_name", "Table", "text"],
                ["column_name", "Column", "text"], ["measure_name", "Measure", "text"],
                ["permission_code", "Permission", "text"], ["nullable", "Nullable", "checkbox"],
                ["configuration_status", "Configuration", "select", ["Configured", "Not Configured", "Invalid", "Disabled"]],
                ["validation_status", "Validation", "select", ["Draft", "To Review", "Validated", "Rejected"]],
                ["active", "Active", "checkbox"],
            ],
        },
        "answerability-rules": {
            title: "Answerability Rules",
            columns: ["name", "minimum_entity_confidence", "minimum_knowledge_confidence", "require_structured_evidence", "active"],
            fields: [
                ["name", "Name", "text"], ["minimum_entity_confidence", "Minimum entity confidence", "number"],
                ["minimum_knowledge_confidence", "Minimum knowledge confidence", "number"],
                ["require_structured_evidence", "Require structured evidence", "checkbox"],
                ["require_document_evidence", "Require document evidence", "checkbox"],
                ["allow_general_model_knowledge", "Allow general model knowledge", "checkbox"],
                ["allow_hypothesis_mode", "Allow hypothesis mode", "checkbox"],
                ["show_available_alternatives", "Show available alternatives", "checkbox"],
                ["show_source_summary", "Show source summary", "checkbox"],
                ["log_data_gaps", "Log data gaps", "checkbox"],
                ["allow_data_gap_reporting", "Allow data-gap reporting", "checkbox"],
                ["active", "Active", "checkbox"],
            ],
        },
        "source-precedence": {
            title: "Source Precedence",
            columns: ["business_field", "entity_type", "primary_source", "secondary_source", "priority", "validation_status", "active"],
            fields: [
                ["business_field", "Business field code", "text"], ["entity_type", "Entity type", "text"],
                ["primary_source", "Primary source", "text"], ["secondary_source", "Secondary source", "text"],
                ["conditions_json", "Conditions", "json"], ["effective_from", "Effective from", "date"],
                ["effective_to", "Effective to", "date"], ["priority", "Priority", "number"],
                ["owner", "Owner", "text"],
                ["validation_status", "Validation", "select", ["Draft", "To Review", "Validated", "Rejected"]],
                ["active", "Active", "checkbox"],
            ],
        ...
        "data-gaps": {
            title: "Data Gaps",
            readonly: true,
            columns: ["requested_field_code", "entity_type", "entity_identifier", "occurrence_count", "answerability_status", "resolution_status", "last_requested_at"],
            fields: [],
        },
        "response-templates": {
